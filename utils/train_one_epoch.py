...
def train_one_epoch(model, optimizer, data_loader, device, epoch, num_classes, step):
    ...
    for _, batch_data in enumerate(data_loader):
        ...
        if step % 10 == 0:
            print("---------step:{} ,  dice:{}  {}   {} {}------ ".format(step, dice_metric[1].item(),
                                                                          dice_metric[2].item(), dice_metric[3].item(),
                                                                          dice_metric[4].item()))
    ...
    print('train---------epoch:{} , loss: {} , dice:  {}  {}  {} {}' \
          .format(epoch, epoch_mean_loss, epoch_mean_dice[0][1].item(), epoch_mean_dice[0][2].item(),
                  epoch_mean_dice[0][3].item(), epoch_mean_dice[0][4].item()))
